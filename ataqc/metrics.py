...
# TODO somewhere here we want to put the cutoffs and save in a way that it is easy to visualize however we like
# And also save separate thresholds table that is easy to compare against
